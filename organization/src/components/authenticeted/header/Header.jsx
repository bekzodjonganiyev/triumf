    ...
    <header className="py-10">
      <div className="flex justify-between items-center gap-9">
        ...
        <div className="flex justify-end items-cente w-2/12">
          <button className="bg-secondary text-white flex gap-2 py-3 px-4 rounded-xl" onClick={() => handleEvent2()}><span><UploadLetterSvg /> </span> {t("UploadButton")}</button>
          {/* <button className="bg-secondary text-white flex gap-2 py-3 px-4 rounded-xl" onClick={() => handleEvent1()}><span><UploadLetterSvg /> </span> PDF файл юклаш</button> */}
        </div>
      </div>
